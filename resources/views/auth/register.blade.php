        ...
        <section class="card">
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="grid">
                    ...
                    <div><label>Employee ID</label><input type="text" name="employee_id" value="{{ old('employee_id') }}" placeholder="e.g., HR-2000-001" readonly style="background-color:#f5f5f5;cursor:not-allowed"><small style="display:block;margin-top:4px;font-size:12px;color:#999">Auto-generated by HR upon account activation</small></div>
