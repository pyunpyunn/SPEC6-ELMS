...
<div class="page active" id="page-verification">
    ...
    <div class="tab-pane" id="all-tab" style="display:none">
        <div class="card" style="box-shadow:none;border:none">
            <form class="filter-bar" method="GET" action="{{ route('hr.users.index') }}">
                ...
                @forelse($allUsers as $user)
                    ...
                    <td class="actions">
                            @if($user->status === 'active')
                                <form method="POST" action="{{ route('hr.users.deactivate', $user) }}">
                                    @csrf
                                    @method('PATCH')
        ...
        <form class="modal-body form" method="POST" id="activateForm">
            ...
            <div class="grid" style="grid-template-columns:1fr 1fr;gap:14px">
                ...
                <div class="form-group">
                    ...
                    <select name="position" id="activatePosition" required>
...
function openActivateModal(data) {
    ...
    activateState.action = data.action || '{{ url("/hr/users") }}/' + data.id + '/activate';
    ...
    document.getElementById('activatePosition').value = data.position || '';
