...
<div class="app">
    <aside class="sidebar" id="sidebar">
        ...
        <nav class="sb-nav">
            ...
            <a class="sb-item {{ request()->routeIs('hr.dashboard') ? 'active' : '' }}" href="{{ route('hr.dashboard') }}">
            ...
            <a class="sb-item {{ request()->routeIs('hr.calendar') ? 'active' : '' }}" href="{{ route('hr.calendar') }}">
            ...
            <a class="sb-item {{ request()->routeIs('hr.users.*') ? 'active' : '' }}" href="{{ route('hr.users.pending') }}">
            ...
            <a class="sb-item {{ request()->routeIs('hr.employees.*') ? 'active' : '' }}" href="{{ route('hr.employees.index') }}">
            ...
            <a class="sb-item {{ request()->routeIs('hr.departments.*') ? 'active' : '' }}" href="{{ route('hr.departments.index') }}">
            ...
            <a class="sb-item {{ request()->routeIs('hr.requests.*') ? 'active' : '' }}" href="{{ route('hr.requests.index') }}">
            ...
            <a class="sb-item {{ request()->routeIs('hr.leave-types.*') ? 'active' : '' }}" href="{{ route('hr.leave-types.index') }}">
            ...
            <a class="sb-item {{ request()->routeIs('hr.my-leave') ? 'active' : '' }}" href="{{ route('hr.my-leave') }}">
            ...
            <a class="sb-item {{ request()->routeIs('hr.reports.*') ? 'active' : '' }}" href="{{ route('hr.reports.index') }}">
