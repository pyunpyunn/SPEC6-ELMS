    ...
    <div class="card">
        ...
        <div class="card-body" style="display:flex;flex-direction:column;gap:12px">
            @forelse($notifications as $n)
                <a href="{{ $n->action_url ?: route('notifications.read', $n) }}" class="dept-leave-row" style="padding:14px 16px;border:1px solid var(--border);border-radius:16px;background:var(--surface);display:block">
