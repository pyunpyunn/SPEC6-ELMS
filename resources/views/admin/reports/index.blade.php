...
<div class="page-head">
    ...
    <div class="actions">
        <a class="btn btn-outline btn-sm" href="{{ route('admin.reports.export', request()->all() + ['type' => 'leaves']) }}">Export Leaves (CSV)</a>
        <a class="btn btn-outline btn-sm" href="{{ route('admin.reports.export', request()->all() + ['type' => 'balances']) }}">Export Balances (CSV)</a>
    </div>
</div>
        ...
        @if($employeeReport)
            <div class="card" style="box-shadow:none;margin-top:12px">
                <div class="card-h">
                    ...
                    <a class="btn btn-outline btn-sm" href="{{ route('admin.reports.export', ['type' => 'balances', 'department_id' => $employeeReport->department_id, 'year' => $year]) }}">Download CSV</a>
                </div>
                <div class="card-b">
